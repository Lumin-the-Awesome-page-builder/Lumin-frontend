import {PropertyObject} from "@/editor/core/property/Property";
...
export default abstract class Component {
  ...
  public property: PropertyCollection = PropertyCollection.empty()
  ...
  render() {
    ...
    if (this.children && this.children.length)
      ...
      this.htmlElement.innerText = this.content
